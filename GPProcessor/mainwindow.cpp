    ...
    , ui(new Ui::MainWindow)
{
    ...
    ui->checkBox_linearGrammar->setDisabled(true);
    ui->checkBox_lLinearGrammar->setDisabled(true);
    ui->checkBox_rLinearGrammar->setDisabled(true);
    ui->checkBox_nonLinearGrammar->setDisabled(true);
    ...
    ui->pushButton_isGrammarLinear->setDisabled(true);
